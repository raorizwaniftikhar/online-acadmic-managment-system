...
<tr>
	<th colspan="3" style="font-size:24px; font-family:Georgia" align="center">Clerk's Change Password</th>
</tr>
<form  action="clerk_chpass0.php" method="post" enctype="multipart/form-data" onSubmit="return ValidateForm()" name="myform">
