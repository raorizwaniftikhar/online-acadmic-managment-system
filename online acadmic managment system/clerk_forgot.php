...
<tr>
	<th colspan="3" style="font-size:24px; font-family:Georgia" align="center">Clerk's Forgot password</th>
</tr>
<form  action="clerk_forgot0.php" method="post" enctype="multipart/form-data" onSubmit="return ValidateForm()" name="myform">
