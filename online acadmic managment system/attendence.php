...
<table  class="mainForm">
	<tr>
	<th colspan="2" style="font-size:24px; font-family:Georgia" align="center">Attendence</th> 
	</tr>
	<form method="post" action="attendence0.php" enctype="multipart/form-data" name="myform" onSubmit="return ValidateForm();">
<tr><td>Class:</td>
<td>
...
<tr><td>Attendence Status:</td><td><input  type="radio" name="attend" value="present"/>Present<input type="radio" name="attend" value="absent" />Absent</td></tr>
