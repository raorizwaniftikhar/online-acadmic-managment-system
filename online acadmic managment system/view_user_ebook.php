...
<form method="post" action="view_user_ebook0.php" name="myform" onSubmit="return validate()";>
...
<?php
		...
		?>
				 ...
				 <table  class="mainForm">
				 <form action="view_user_ebook00.php" method="post" name="myform1" onSubmit="return validate1()";>
