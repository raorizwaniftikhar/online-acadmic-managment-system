...
$sql="select * from clerk_login where (email='".$email."' and squestion='".$squestion."' and sanswer='".$sanswer."')";
...
?>
		...
		<tr><th>Password:</th><td colspan="3"><?php echo $row['password'];?></td></tr>
